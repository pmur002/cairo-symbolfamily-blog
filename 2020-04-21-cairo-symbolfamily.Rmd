...
pdf("cairo-symbolfamily-files/CMitalic.pdf", family=CMitalic, height=2)
grid.text(expression(paste(frac(1, sigma*sqrt(2*pi)), " ",
                           plain(e)^{frac(-(x-mu)^2, 2*sigma^2)})))
dev.off()
...
system("convert -density 96 cairo-symbolfamily-files/CMitalic-embedded.pdf cairo-symbolfamily-files/CMitalic.png")
```

![](/Blog/public/post/cairo-symbolfamily-files/CMitalic.png)
